...
::
	...
	<ReservationRQ>
		...
		<ResGuests>
            <Holder name ="TestHolder" surname ="TestApHolder" nationality="ES"/>		
			<Guests>
...
+------------------------------------------+----------+-----------+-------------------------------------------------------------------------------------------------------------------------------------------------------+
| Holder                                   | 0..1     |           | Price range accepted by the client to be higher than valuation and confirmation process.                                                              |
+------------------------------------------+----------+-----------+-------------------------------------------------------------------------------------------------------------------------------------------------------+
